...
#define LUCE_MACRO_SUPPORTED_CHAR_1632 (LUCE_CONFIG_CHAR_1632 == LUCE_CONFIG_YES)
...
#define LUCE_MACRO_SUPPORTED_LONGLONG (LUCE_CONFIG_LONGLONG == LUCE_CONFIG_YES)
#define LUCE_MACRO_SUPPORTED_NOEXCEPT (LUCE_CONFIG_NOEXCEPT == LUCE_CONFIG_YES)
